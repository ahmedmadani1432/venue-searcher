...
const Button = ({
  ...
  const variantClasses = {
    primary: 'bg-pink-100 text-pink-700 hover:bg-pink-200 focus:ring-pink-300',
    secondary: 'bg-lavender-100 text-lavender-700 hover:bg-lavender-200 focus:ring-lavender-300',
